        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name hidden-md-down">{{ Auth::guard('admin_guard')->user()->name }}</span>
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                ...
                <h6 class="logged-fullname">{{ Auth::guard('admin_guard')->user()->name }}</h6>
                <p>{{ Auth::guard('admin_guard')->user()->email }}</p>
              </div>
              <hr>
              <div class="tx-center">
